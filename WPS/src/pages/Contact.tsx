...
export default function Contact() {
  return (
    <>
      ...
      <section
        className="section-sm border-t border-[#181818]"
        ...
        <div className="page-width grid gap-6 min-[980px]:grid-cols-[1.35fr_0.65fr]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Reveal delay={140}>
              <a
                href={PHONE_TEL}
                className="card card-hover group flex items-center gap-5 p-7"
              >
                ...
                <span>
                  <span className="t-eyebrow block !text-[0.64rem] text-mut2">
                    USA Phone
                  </span>
            ...
            <Reveal delay={180}>
              <a
                href="mailto:webproxysolutions@gmail.com"
                className="card card-hover group flex items-center gap-5 p-7"
              >
                <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg border border-[#a8e06330] bg-[#a8e06312]">
                  <Mail
                    size={19}
                    className="text-[#a8e063]"
                    aria-hidden
                  />
                </span>
                ...
                <span className="min-w-0">
                  ...
                  <span className="mt-1.5 block break-all text-[1rem] font-bold tracking-[-0.02em] text-fg transition-colors group-hover:text-warm">
                    webproxysolutions@gmail.com
                  </span>
                </span>
              </a>
            </Reveal>
            ...
            <Reveal delay={220}>
              <div className="card p-7">
                <span className="flex h-12 w-12 items-center justify-center rounded-lg border border-[#ffb35c30] bg-[#ffb35c12]">
                  <CreditCard
                    size={19}
                    className="text-[#ffb35c]"
                    aria-hidden
                  />
                </span>

                <h2 className="mt-6 text-[1.05rem] font-bold text-fg">
                  Pay securely with PayPal
                </h2>

                <p className="mt-2.5 text-[0.88rem] leading-relaxed text-mut">
                  Prefer to get started right away? You can pay for your project
                  securely through our official PayPal page.
                </p>
            ...
            <Reveal delay={280}>
              <div className="card p-7">
                ...
                <p className="mt-2.5 text-[0.88rem] leading-relaxed text-mut">
                  We serve small businesses across the{" "}
                  <span className="font-semibold text-fg">USA</span> and{" "}
                  <span className="font-semibold text-fg">Australia</span> —
                  every project handled remotely with clear, friendly
                  communication.
                </p>

                <div className="mt-5 flex gap-2">
                  <span
                    className="chip !py-1.5 !text-[0.7rem]"
                    style={
                      { "--chip-accent": "#6ea1ff" } as React.CSSProperties
                    }
                  >
                  ...
                  <span
                    className="chip !py-1.5 !text-[0.7rem]"
                    style={
                      { "--chip-accent": "#ffb35c" } as React.CSSProperties
                    }
                  >
